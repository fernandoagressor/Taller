...
public class SupervisorController {
 ...
 @PostMapping("/camiones/{camionId}/conductor/{conductorId}")
 public Camion asociar(@PathVariable Long camionId,@PathVariable Long conductorId){
  return camiones.asociar(camionId,conductorId);}

 @DeleteMapping("/camiones/{camionId}/conductor")
 public Camion desasociar(@PathVariable Long camionId){
  return camiones.desasociar(camionId);}
}
