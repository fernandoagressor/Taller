...
public class UsuarioService {
 ...
 public Usuario crear(UsuarioRequest r){return repo.save(Usuario.builder().username(r.username()).password(encoder.encode(r.password())).rol(r.rol()).activo(true).build());}
